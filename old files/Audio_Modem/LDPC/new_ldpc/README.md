...
(where all protographs have been optimised for every combination
...
High Sierra. You will need to have installed Python 3 and make sure
...
is to install anaconda, and package environment manager, then type
